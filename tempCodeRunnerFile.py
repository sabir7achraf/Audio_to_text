...
if __name__ == "__main__":
    ...
    # Exemple de texte
    original_text = "مَحْمُودٌ وَالِدُ زَيْدٍ, وهُوَ يَعْمَلُ فِي شَرِيكَةٍ فِي الْعَاصِمَةِ يَعْمَلُ سَبْعَ سَاعَاتٍ فِي الْيَوْمِ وهُوَ يُحِبُّ عَمَلَهُ فاطِمَةُ وَالِدَةُ زَيْدٍ ,  وهِيَ طَبِيبَةٌ فِي مُسْتَشْفَى ,  خَاصٍّ الْمُسْتَشْفَى قَرِيبٌ مِنَ الْبَيْتِ وَهِيَ تَعْمَلُ صَبَاحًا فَقَطْ"
    transcribed_text = "مَحْمُودًا والِدَةُ زَيدًا وَهُوَ يَعْمَل فِي شَرِيكَةٍ فِي ألْعاصِمَةَ , يَعْمَلِ سبعُ سَاعَاتٍ فِي الْيَومِ وَهُوَ يُحِبَّ عمَلَهُ فاطِمَةٌ والِدَةَ زَيْدٍ  , واهِيََ طَبِيبَةُ فِي مُستَشْفَى خَاصّا الْمُستَشْفَى قَرِيبٌ مينَ الْبَيتَ وهِيَ تَعْمَلُ صَبَاحٌ فَقَط"
